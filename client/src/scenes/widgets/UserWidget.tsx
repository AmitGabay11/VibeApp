      ...
      <WidgetWrapper>
          ...
          <FlexBetween gap="0.5rem" pb="1.1rem" onClick={() => navigate(`/profile/${userId}`)}>
              <FlexBetween gap="1rem">
                  <UserImage image={`${backendUrl}/upload/${user.picturePath}`} />
                  <Box>
                      <Typography
                          variant="h4"
                          color={dark}
          ...
          <Box p="1rem 0">
              ...
              <FlexBetween gap="1rem">
                  <FlexBetween gap="1rem">
                      <img src="https://img.freepik.com/free-vector/new-2023-twitter-logo-x-icon-design_1017-45418.jpg" alt="X Logo" width="30px" height="30px" />
                      <Box>
              ...
              <FlexBetween gap="1rem">
                  <FlexBetween gap="1rem">
                      <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/ca/LinkedIn_logo_initials.png/600px-LinkedIn_logo_initials.png" alt="LinkedIn" width="30px" height="30px" />
                      <Box>
